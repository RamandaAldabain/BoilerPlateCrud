...
namespace StudentsCrud.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly StudentsCrudDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = StudentsCrudConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(StudentsCrudDbContext context)
        {
            _context = context;
        }
