...
{
    public abstract class StudentsCrudWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static StudentsCrudWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(StudentsCrudWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<StudentsCrudDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<StudentsCrudDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<StudentsCrudDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<StudentsCrudDbContext, Task<T>> func)
        {
            T result;
